...
[![Powered by CIRpy](https://img.shields.io/badge/Powered_by-CIRpy-red)](https://cirpy.readthedocs.io)
[![License](https://img.shields.io/badge/license-GNUv3.0-green)](https://github.com/kpenabar/smilesbot/blob/main/LICENSE)
## What is it?
SMILES.bot is a Discord bot for rendering chemical structures and equations using SMILES notation.
